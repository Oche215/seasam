...
from .views import (home, about, contact, mineral, mineral_detail, search, minerals, mineral_description, mb,
                    ss, sw, nw, ne, se, log, contract, mineral_description_states)
...
urlpatterns = [
    ...
    path('mineral_description_states/<int:pk>', mineral_description_states, name='mineral_description_states'),
